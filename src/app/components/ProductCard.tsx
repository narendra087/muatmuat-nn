...
const ProductCard = ({ product, handleEdit }: IProductCardProps) => {
  ...
  return (
    <>
      <Stack sx={{ flexDirection: 'row' }} className="p-4 rounded-lg bg-white justify-between">
        <Stack sx={{ flexDirection: 'row' }} className="gap-4">
          <Image
          ...
          />
          <Box>
            <Typography className="text-xl font-bold">{product.title}</Typography>
        ...
        <Stack className="justify-between">
          <Typography className="text-right">Stock: <b>{product.stock}</b></Typography>
